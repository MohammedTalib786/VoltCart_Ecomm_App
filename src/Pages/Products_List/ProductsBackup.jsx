...
const Products = () => {
    ...
    console.log('products prodData:', prodData)

    const checkBoxChanged = (e) => {
        let { value, checked } = e.target;
        // checked ? setcheckValue((prevItem) => [...prevItem, value]) : setcheckValue([])
    ...
    // const handlerChangePriceFilter = (e) => {
    //     setPriceFilter(e.target.value)
    //     // console.log('change inp')
    // }

    // console.log('input range', priceFilter)
