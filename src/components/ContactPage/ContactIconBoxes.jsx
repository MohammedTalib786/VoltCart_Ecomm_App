...
const ContactIconBoxes = () => {
    return (
        <div className=" contact_icon_boxes w-[100%] flex flex-col justify-center gap-[50px] lg:gap-[75px] md:my-20 mb-[20px] ">
            ...
            <div className="w-[100%] md:w-[100%] flex  gap-[70px] md:gap-[20px] lg:flex-row flex-wrap">
                ...
                <div className="group w-[100%] md:w-[46%] lg:w-[32%] text-center pt-[70px] pb-[30px] px-[20px] rounded-[12px] relative " >
                    <div className="w-fit iconStyle transition-all duration-300 ease-in-out">
                        <FaLocationDot className="w-[30px] h-[30px] fill-[#595959] transition-all duration-300 ease-in-out  " />
                    </div>
                ...
                <div className="group w-[100%] md:w-[46%] lg:w-[32%]  text-center  pt-[70px] pb-[30px] px-[20px] rounded-xl relative transition-all duration-300 ease-in-out">
                    ...
                    <h5 className="font-primary font-[500] text-[22px]  " >Connect over call</h5>
                ...
                <div className="group w-[100%] md:w-[46%] lg:w-[32%] text-center pt-[70px] pb-[30px] px-[20px] rounded-xl relative transition-all duration-300 ease-in-out">
                    ...
                    <div className="w-fit iconStyle transition-all duration-300 ease-in-out">
                        <MdEmail className="w-[30px] h-[30px] fill-[#595959] transition-all duration-300 ease-in-out  " />
                    </div>
                    <h5 className="font-primary font-[500] text-[22px]  ">Contact via mail</h5>
