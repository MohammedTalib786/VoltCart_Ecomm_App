...
const ContactForm = ({
    ...
    return (
        <div className=' relative gt-tab:w-[50%] w-full h-full flex flex-col bg-white desktop:px-[30px] desktop:pt-[25px] desktop:pb-[35px] gt-tab:px-[25px] gt-tab:pt-[25px] gt-tab:pb-[35px] px-[20px] pt-[25px] pb-[35px] rounded-[16px] ' >
            ...
            >Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit molestias voluptas libero sint. Maiores consequuntur in consectetur</p>
            ...
            >
                ...
                <div className=" tab:w-fit w-full ">
                    ...
                    <Button
                        ...
                        disabled={isDisabled}
                        // text={<Loader />}
                        additionalClass=" tab:w-fit w-full min-w-[140px] "
