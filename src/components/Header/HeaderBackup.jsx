...
//                                 <NavLink to='/' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-primary text-[18px]/[24px] font-[400]  text-black block tracking-[0.5px]  "} >Home</NavLink>
//                             </li>
//                             <li className='max-lg:border-b '>
//                                 <NavLink to='/about-us' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-primary text-[18px]/[24px] font-[400]  text-black block tracking-[0.5px] "} >About Us</NavLink>
//                             </li>
//                             <li className='max-lg:border-b '>
//                                 <NavLink to='/blogs' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-primary text-[18px]/[24px] font-[400]   text-black block tracking-[0.5px] "} >Blogs</NavLink>
//                             </li>
//                             <li className='max-lg:border-b '>
//                                 <NavLink to='/products' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-primary text-[18px]/[24px] font-[400]   text-black block tracking-[0.5px] "} >Products</NavLink>
//                             </li>
//                             <li className='max-lg:border-b '>
//                                 <NavLink to='/contact-us' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-primary text-[18px]/[24px] font-[400]  text-black block tracking-[0.5px] "} >Contact</NavLink>
//                             </li>
//                             {/* <li className='max-lg:border-b '>
...
//                         {/* <MdOutlineSearch
//                             className=' text-[28px]/[28px] text-black   '
//                         /> */}
...
//                         {/* <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24"><path fill="currentColor" d="M10 18a7.95 7.95 0 0 0 4.897-1.688l4.396 4.396l1.414-1.414l-4.396-4.396A7.95 7.95 0 0 0 18 10c0-4.411-3.589-8-8-8s-8 3.589-8 8s3.589 8 8 8m0-14c3.309 0 6 2.691 6 6s-2.691 6-6 6s-6-2.691-6-6s2.691-6 6-6" /></svg> */}

//                         <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="currentColor" d="M9.5 16q-2.725 0-4.612-1.888T3 9.5t1.888-4.612T9.5 3t4.613 1.888T16 9.5q0 1.1-.35 2.075T14.7 13.3l5.6 5.6q.275.275.275.7t-.275.7t-.7.275t-.7-.275l-5.6-5.6q-.75.6-1.725.95T9.5 16m0-2q1.875 0 3.188-1.312T14 9.5t-1.312-3.187T9.5 5T6.313 6.313T5 9.5t1.313 3.188T9.5 14" /></svg>
...
//                             <path d="M10.6 30.625C9.61152 29.6431 8.82835 28.4743 8.29613 27.1866C7.7639 25.899 7.49327 24.5183 7.5 23.125C7.5 20.3071 8.61942 17.6046 10.612 15.612C12.6046 13.6195 15.3071 12.5 18.125 12.5C22.075 12.5 25.525 14.65 27.35 17.85H30.15C31.0778 16.2227 32.4203 14.8703 34.0407 13.9305C35.6612 12.9907 37.5017 12.4971 39.375 12.5C42.1929 12.5 44.8954 13.6195 46.888 15.612C48.8806 17.6046 50 20.3071 50 23.125C50 26.05 48.75 28.75 46.9 30.625L28.75 48.75L10.6 30.625ZM48.65 32.4C51.025 30 52.5 26.75 52.5 23.125C52.5 19.6441 51.1172 16.3057 48.6558 13.8443C46.1944 11.3829 42.856 10 39.375 10C35 10 31.125 12.125 28.75 15.425C27.5378 13.7413 25.9415 12.3708 24.0937 11.4274C22.2459 10.4839 20.1997 9.99459 18.125 10C14.644 10 11.3056 11.3829 8.84422 13.8443C6.38281 16.3057 5 19.6441 5 23.125C5 26.75 6.475 30 8.85 32.4L28.75 52.3L48.65 32.4Z" fill="black" />
//                         </svg> */}

//                         {/* <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="currentColor" d="m8.962 18.91l.464-.588zM12 5.5l-.54.52a.75.75 0 0 0 1.08 0zm3.038 13.41l.465.59zm-5.612-.588C7.91 17.127 6.253 15.96 4.938 14.48C3.65 13.028 2.75 11.335 2.75 9.137h-1.5c0 2.666 1.11 4.7 2.567 6.339c1.43 1.61 3.254 2.9 4.68 4.024zM2.75 9.137c0-2.15 1.215-3.954 2.874-4.713c1.612-.737 3.778-.541 5.836 1.597l1.08-1.04C10.1 2.444 7.264 2.025 5 3.06C2.786 4.073 1.25 6.425 1.25 9.137zM8.497 19.5c.513.404 1.063.834 1.62 1.16s1.193.59 1.883.59v-1.5c-.31 0-.674-.12-1.126-.385c-.453-.264-.922-.628-1.448-1.043zm7.006 0c1.426-1.125 3.25-2.413 4.68-4.024c1.457-1.64 2.567-3.673 2.567-6.339h-1.5c0 2.198-.9 3.891-2.188 5.343c-1.315 1.48-2.972 2.647-4.488 3.842zM22.75 9.137c0-2.712-1.535-5.064-3.75-6.077c-2.264-1.035-5.098-.616-7.54 1.92l1.08 1.04c2.058-2.137 4.224-2.333 5.836-1.596c1.659.759 2.874 2.562 2.874 4.713zm-8.176 9.185c-.526.415-.995.779-1.448 1.043s-.816.385-1.126.385v1.5c.69 0 1.326-.265 1.883-.59c.558-.326 1.107-.756 1.62-1.16z" /></svg> */}

//                         <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 12.572L12 20l-7.5-7.428A5 5 0 1 1 12 6.006a5 5 0 1 1 7.5 6.572" /></svg>
...
//                         {/* <svg width="34" height="34" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
//                             <path stroke="black" stroke-width="5" d="M25 51.25C27.0711 51.25 28.75 49.5711 28.75 47.5C28.75 45.4289 27.0711 43.75 25 43.75C22.9289 43.75 21.25 45.4289 21.25 47.5C21.25 49.5711 22.9289 51.25 25 51.25Z"  />
//                             <path stroke="black" stroke-width="5" d="M42.5 51.25C44.5711 51.25 46.25 49.5711 46.25 47.5C46.25 45.4289 44.5711 43.75 42.5 43.75C40.4289 43.75 38.75 45.4289 38.75 47.5C38.75 49.5711 40.4289 51.25 42.5 51.25Z"  />
//                             <path stroke="black" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" d="M8.75 10H13.75L22.51 37.5H42.5"  />
//                             <path stroke="black" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" d="M20.56 31.25L15.75 16.25H47.0175C47.2157 16.2498 47.4111 16.2966 47.5875 16.3868C47.764 16.4769 47.9166 16.6077 48.0326 16.7684C48.1486 16.929 48.2247 17.115 48.2547 17.3109C48.2846 17.5068 48.2676 17.707 48.205 17.895L44.0375 30.395C43.9546 30.6438 43.7956 30.8602 43.5829 31.0137C43.3703 31.1671 43.1147 31.2498 42.8525 31.25H20.56Z"  />
//                         </svg> */}
