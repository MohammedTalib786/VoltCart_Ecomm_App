                    ...
                    <div className=' head_foot_cont max-w-[1440px] flex flex-wrap justify-center items-center gt-tab:p-0 mx-auto w-full ' id='collapseMenu' >
                        <ul
                            ...
                            <li className='max-lg:border-b '>
                                <NavLink to='/' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-medium  font-body text-black block text-[16px]"} >Home</NavLink>
                            </li>
                            <li className='max-lg:border-b '>
                                <NavLink to='/about-us' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-medium  font-body text-black block text-[16px]"} >About Us</NavLink>
                            </li>
                            <li className='max-lg:border-b '>
                                <NavLink to='/blogs' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-medium  font-body text-black block text-[16px]"} >Blogs</NavLink>
                            </li>
                            <li className='max-lg:border-b '>
                                <NavLink to='/products' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active" : " relative font-medium  font-body text-black block text-[16px]"} >Products</NavLink>
                            </li>
                            <li className='max-lg:border-b '>
